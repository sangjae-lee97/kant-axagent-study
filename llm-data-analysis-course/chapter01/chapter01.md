...
```text
https://github.com/sangjae-lee97/kant-axagent-study/blob/main/llm-data-analysis-course/chapter01/chapter01.md
```
...
- 기간: 최근 1년
- 기준: 월별
- 비교 방법: 언제, 어떤 상품이 감소하는지 확인
- 분석 목적: 감소가 특정 월이나 상품 카테고리에 집중되는지 확인

### 분석 가능한 질문으로 다시 작성

```text
최근 1년 동안 completed 주문 기준 금액의 변화를 파악하고, 더 나아가 어떤 상품 카테고리가 감소하고 어느 달에 특히 감소하는가?
```
